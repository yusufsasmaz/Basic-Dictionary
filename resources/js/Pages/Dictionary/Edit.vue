          ...
          <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <form @submit.prevent="submit" class="mx-auto mt-8 mb-0 max-w-md space-y-4">
              ...
              <div>
                ...
                <div class="relative">
                  <textarea v-model="form.description" id="description" class="w-full rounded-lg border-gray-200 p-4 pr-12 text-sm shadow-sm" rows="5" cols="50" placeholder="Description" />
                </div>
              </div>
              
              <div class="flex items-center justify-between">
                <button type="submit" :disabled="form.prossesing" class="inline-block rounded-lg bg-blue-500 px-5 py-3 text-sm font-medium text-white"> * Edit</button>
              </div>
            </form>
          </div>
        </div>
...
let form = useForm({
  italian: props.words.italian,
  english: props.words.english,
  description: props.words.description,
  id: props.words.id,
});
